#ifndef OSRAM_EXTRACTOR_INTERSECTION_CONSTANTS
#define OSRAM_EXTRACTOR_INTERSECTION_CONSTANTS
namespace osram {
namespace extractor {
...
// angle difference that can be classified as straight, if its the only narrow
// turn
const double constexpr FUZZY_ANGLE_DIFFERENCE = 25.;

// Road priorities give an idea of how obvious a turn is. If two priorities
// differ greatly (e.g. service road over a primary road, the better priority
// can be seen as obvious due to its road category).
